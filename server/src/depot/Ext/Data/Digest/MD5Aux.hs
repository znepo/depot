...
-- removed because I don't think it will make a difference 
-- {-
...
-- #define rotL rotateL
-- #include "Ext.Zord64_EASY.hs"
-- #else

-- > import Ext.Zord64_HARD
...
instance Num ABCD where
 ...
 ABCD (a1, b1, c1, d1) * ABCD (a2, b2, c2, d2) = ABCD (a1 * a2, b1 * b2, c1 * c2, d1 * d2)  
 abs abcd         = error "abs not implemented for ABCD"
 signum abcd      = error "signum not implemented for ABCD"
 fromInteger abcd = error "fromInteger not implemented for ABCD"
